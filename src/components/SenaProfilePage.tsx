          ...
          <div>
            ...
            <div className="rounded-[1.1rem] border border-[var(--terracotta)]/13 bg-white/62 p-6 sm:p-8">
              ...
              <p className="mt-5 text-base leading-8 text-[oklch(0.43_0.035_35)] sm:text-lg">
                Bedensel bütünlüğünüzü korumak, yaşam kalitenizi artırmak ve ağrısız bir hayata adım
                atmanızı sağlamak için buradayım. Fizyoterapi alanındaki güncel gelişmeleri ve
                yenilikçi tedavi yöntemlerini yakından takip ederek, bugüne kadar alanımla ilgili 23
                farklı uzmanlık eğitimi aldım. Bu güçlü mesleki donanımla, bugüne dek 300'den fazla
                danışanımın iyileşme yolculuğuna rehberlik etmenin ve yüksek memnuniyet sağlamanın
